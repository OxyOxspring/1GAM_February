...
var backwardsSpeed : float = 0.0f;

var walkForwardSpeed : float = 5.0;
var walkSidewaysSpeed : float = 5.0;
var walkBackwardsSpeed : float = 3.0;
var crouchForwardSpeed : float = 2.0f;
var crouchSidewaysSpeed : float = 2.0f;
var crouchBackwardsSpeed : float = 1.5f;
...
function MaxSpeedInDirection (desiredMovementDirection : Vector3) : float {
	if (desiredMovementDirection == Vector3.zero)
		...
		var zAxisEllipseMultiplier : float = (desiredMovementDirection.z > 0 ? forwardSpeed : backwardsSpeed) / sidewaysSpeed;
		var temp : Vector3 = new Vector3(desiredMovementDirection.x, 0, desiredMovementDirection.z / zAxisEllipseMultiplier).normalized;
		var length : float = new Vector3(temp.x, 0, temp.z * zAxisEllipseMultiplier).magnitude * sidewaysSpeed;
		return length;
	}
}
